				...
				.addFields(
					{
						...
						value: `**${
							voteCooldown < 43200000
								? `:thumbsdown: ${msToTime(43200000 - voteCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							scratchCooldown > 0
								? `:thumbsdown: ${msToTime(scratchCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							workCooldown > 0
								? `:thumbsdown: ${msToTime(workCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							fishCooldown > 0
								? `:thumbsdown: ${msToTime(fishCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							exploreCooldown > 0
								? `:thumbsdown: ${msToTime(exploreCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							mineCooldown > 0
								? `:thumbsdown: ${msToTime(mineCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
					{
						...
						value: `**${
							huntCooldown > 0
								? `:thumbsdown: ${msToTime(huntCooldown)}`
								: `:thumbsup: ${instance.getMessage(interaction, 'READY')}`
						}**`,
						inline: true,
					},
